...
export default function WorkoutBuilderScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.page} keyboardShouldPersistTaps="handled">
    ...
    <Eyebrow>{dayLabel}</Eyebrow><ScreenTitle subtitle={`Build the session scheduled for ${dayLabel}. You can still make changes while training.`}>Plan workout</ScreenTitle>
