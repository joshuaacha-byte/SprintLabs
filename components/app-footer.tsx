...
export function AppFooter() {
  return (
    <View style={styles.footer}>
      <Text style={styles.credit}>SprintLab prototype · Joshua Acha · 2026</Text>
      <Pressable
        accessibilityRole="link"
        accessibilityLabel="Send SprintLab feedback"
        onPress={() => void WebBrowser.openBrowserAsync(FEEDBACK_URL, { presentationStyle: WebBrowser.WebBrowserPresentationStyle.PAGE_SHEET })}
